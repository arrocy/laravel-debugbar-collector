...
class ArrocyCollector extends DataCollector implements DataCollectorInterface, Renderable
{
    use Modules;
    ...
    public function collect()
    {
        ...
        $info = Info::all();
        $arrocy_version = ! empty($info['arrocy']) ? $info['arrocy'] : '0.0.0';
